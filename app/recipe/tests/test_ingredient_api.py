...
class PrivateIngredientsAPITests(TestCase):
    ...
    def test_ingredients_list_limited_to_user(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name="Vegetable Oil")
    ...
    def test_update_ingredient(self):
        """Test updating a ingredient with patch"""
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Stock Fish')
